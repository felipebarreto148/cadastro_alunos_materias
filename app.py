...
# ------ Label ------
tk.Label(app, text="Bem vindo", bg='#167ec4', font=("Arial", 20), fg="#ffffff").grid(row=0, column=2, padx=35)
...
tk.Button(app, text="Editar Matéria", bg="#0000bb", font=("Arial"), fg="#ffffff").grid(row=0, column=4, padx=8, pady=8)
