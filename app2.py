...
tk.Button(app, text="Editar Aluno", bg="#0000ff", font=("Arial"), fg="#ffffff").grid(row=1, column=0, padx=8, pady=8)
tk.Button(app, text="Remover Aluno", bg="#bb0000", font=("Arial"), fg="#ffffff").grid(row=2, column=0, padx=8, pady=8)
